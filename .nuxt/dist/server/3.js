...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/home/index.vue?vue&type=template&id=644c0b5e&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"home-page"},[_vm._ssrNode("<div class=\"banner\"><div class=\"container\"><h1 class=\"logo-font\">conduit</h1> <p>A place to share your knowledge.</p></div></div> "),_vm._ssrNode("<div class=\"container page\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-md-9\">","</div>",[_vm._ssrNode("<div class=\"feed-toggle\">","</div>",[_vm._ssrNode("<ul class=\"nav nav-pills outline-active\">","</ul>",[(_vm.user)?_vm._ssrNode("<li class=\"nav-item\">","</li>",[_c('nuxt-link',{staticClass:"nav-link",class:{'active':_vm.tab=='your_feed'},attrs:{"exact":"","to":{
                ...
                }}},[_vm._v("Global Feed")])],1),_vm._ssrNode(" "),(_vm.tag)?_vm._ssrNode("<li class=\"nav-item\">","</li>",[_c('nuxt-link',{staticClass:"nav-link",class:{'active':_vm.tab=='tab_feed'},attrs:{"exact":"","to":{
                  name:'home',
                  query:{
                    tab:'tab_feed'
                  }
            ...
            }}},[_c('h1',[_vm._v(_vm._s(item.title))]),_vm._v(" "),_c('p',[_vm._v(_vm._s(item.desscription))]),_vm._v(" "),_c('span',[_vm._v("Read more...")])])],2)}),_vm._ssrNode(" "),_vm._ssrNode("<nav>","</nav>",[_vm._ssrNode("<ul class=\"pagination\">","</ul>",_vm._l((_vm.totalPage),function(item){return _vm._ssrNode("<li"+(_vm._ssrClass("page-item",{
...
// CONCATENATED MODULE: ./pages/home/index.vue?vue&type=template&id=644c0b5e&
...
/* harmony default export */ var homevue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    let limit = 1; // 定义当前tab页

    let tab = query.tab || 'global_feed'; // 定义 获取文章列表是公共的还是 feed的

    let loadArticles = tab == 'your_feed' && store.state.user ? api_article["g" /* getYourFeedArticles */] : api_article["d" /* getArticles */];
    let [articles, tags] = await Promise.all([loadArticles({
      limit,
      offset: (page - 1) * limit,
      tag: query.tag
    }), getTags()]);
    ...
    data.articles.forEach(article => article.favoriteDisabled = false); // console.log(tab)
  ...
  methods: {
    async setFavorite(article) {
      ...
      if (article.favorited) {
        await Object(api_article["h" /* removeFavorite */])(article.slug);
